...
$.ajax({
    ...
    data: {
        key: 'CBUBZ-GAILT-G4PXC-VVADG-UMQFE-ZAFS5',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(116.47123, 40.11753, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
    ...
    else if (date.getDay() >= 1 && date.getDay() < 6 && date.getHours() >= 9 && date.getHours() < 12) timeChange = "<span>上午好</span>，打工人的一天开始了！";
    else if (date.getDay() >= 1 && date.getDay() < 6 && date.getHours() >= 12 && date.getHours() < 13) timeChange = "<span>中午好</span>，是时候摸鱼吃午饭了。";
    else if (date.getDay() >= 1 && date.getDay() < 6 && date.getHours() >= 13 && date.getHours() < 14) timeChange = "<span>午休咯</span>，懒懒地睡个午觉吧！";
    ...
    else if (date.getDay() == 6 && date.getHours() >= 6 && date.getHours() < 9) timeChange = "<span>周六了</span>！休养生息ing~";
    else if (date.getDay() == 6 && date.getHours() >= 9 && date.getHours() < 12) timeChange = "<span>玩点啥</span>？美好的周末，开心！";
